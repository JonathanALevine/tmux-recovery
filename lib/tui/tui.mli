...
(** The interactive navigator. Tab toggles focus between navigation and read-only detail.
    Up/down select a tree row or scroll detail; Home/End jump to the top/bottom. Enter
    expands or collapses navigation branches, and leaves/detail ignore Enter. Details
